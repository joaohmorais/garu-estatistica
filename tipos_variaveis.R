tipos_variaveis <- fluidPage(
  ...
  HTML("<p>Em um determinado estudo ou pesquisa, temos observações relacionadas a algum tipo de característica, o que
    ...
    Algumas variáveis dizem respeito a uma qualidade ou classificação do indivíduo, como seu sexo, a região 
  ...
  fluidRow(
    column(6,
           wellPanel(h4("Variáveis Qualitativas"),
                     HTML("<p>As variáveis qualitativas representam um nome ou característica do indivíduo.
                       Ainda é possível realizar uma distinção dentro desse grupo: as variáveis qualitativas 
                       <strong>nominais</strong>, para quais não há nenhuma possível hierarquia ou ordenação, e as variáveis 
                       qualitativas <strong>ordinais</strong>, para quais há possível representar em determinada ordem. 
    ...
    column(6, 
           wellPanel(h4("Variáveis Quantitativas"),
                     HTML("<p>Como indicado pelo nome, as variáveis quantitativas representam uma quantidade. 
                       ...
                       <strong>discretas</strong>, cujos possíveis valores podem ser listados em um conjunto finito de 
                       números, e as variáveis quantitativas <strong>contínuas</strong>, que podem assumir qualquer valor 
                       real. Um exemplo da primeira é a quantidade de filhos que uma pessoa tem (0, 1, 2, 3, ...), 
